    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white border border-slate-200 p-8 rounded-2xl shadow-[0_20px_60px_-32px_rgba(17,17,17,0.28)] relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-950">Create Account</h2>
          <p className="text-xs text-slate-600 mt-1">Get certified using our adaptive assessment platform</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-600">
          ...
          <Link to="/login" className="text-[#ff6a1f] hover:underline hover:text-[#ff4a03] font-medium">
            Sign In
          </Link>
        </p>
      </div>
