    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">Sign in to access your assessment profile</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-500">
          ...
          <Link to="/register" className="text-primary-400 hover:underline hover:text-primary-300 font-medium">
            Create account
          </Link>
        </p>
      </div>
